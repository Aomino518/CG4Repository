...
void SeekerEngine::Init()
{
	...
	rsComputeSkinning_ = rootSignatureFactory_.CreateComputeSkinning();
	...
	// モデル共通部の作成
	Entity3DCommon::GetInstance()->Init(dxcCompiler_, rs3D_.Get(), rs3dSkinning_.Get(), rsComputeSkinning_.Get());
