...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::CreateSkybox()
{
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::Create3DSkinning()
{
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
	...
	rootParameters[7].Descriptor.ShaderRegister = 0; // レジスタ番号0と使う
