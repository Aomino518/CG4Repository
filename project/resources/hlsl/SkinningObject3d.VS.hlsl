...
VertexShaderOutput main(VertexShaderInput input) // 入力頂点はSkeletonSpace
{
    VertexShaderOutput output;
    Skinned skinned = Skinning(input); // Skinning計算を行って、Skinning後の頂点情報を手に入れる。ここでの頂点もSkeletonSpace
